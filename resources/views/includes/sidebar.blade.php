    ...
    <div class="h-100" data-simplebar>
        ...
        <div id="sidebar-menu">
            ...
            <ul id="side-menu">
                ...
                <li>
                    <a href="#gangguanMenu" data-bs-toggle="collapse">
                        <i data-feather="book-open"></i>
                        <span> Gangguan </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="gangguanMenu">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('gangguan.index') }}" class="tp-link">List Gangguan</a>
                            </li>
                            <li>
                                <a href="{{ route('gangguan.create') }}" class="tp-link">Tambah Gangguan</a>
                            </li>
                        </ul>
                    </div>
                </li>
