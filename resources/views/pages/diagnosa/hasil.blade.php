...
@section('content')
    ...
    <div class="alert alert-info">
        ...
        <p class="mb-2">Berdasarkan {{ count($konsultasi->gejala_terpilih) }} gejala yang Anda pilih, sistem telah
            menganalisis kemungkinan gangguan yang dialami menggunakan 2 metode perhitungan:</p>
        <ol class="mb-0">
            <li><strong>Metode VCIRS</strong> - mengukur keterkaitan gejala dengan masing-masing gangguan</li>
            <li><strong>Metode CF (Certainty Factor)</strong> - menghitung tingkat kepastian berdasarkan penilaian pakar
            </li>
        </ol>
    </div>
                ...
                <h2 class="accordion-header">
                    ...
                    <button class="accordion-button {{ !$loop->first ? 'collapsed' : '' }}" type="button"
                        ...
                        <div class="d-flex justify-content-between align-items-center w-100 me-3">
                            ...
                            <span
                                class="badge badge-result {{ $row['percent'] >= ($sortedHasil->first()['percent'] ?? 0) ? 'bg-danger' : 'bg-primary' }}">
                ...
                <div id="collapse{{ $index }}" class="accordion-collapse collapse {{ $loop->first ? 'show' : '' }}"
                    ...
                    <div class="accordion-body">
                        ...
                        <div class="alert alert-light border mb-4">
                            ...
                            <ol class="mb-0">
                                <li><strong>VCIRS</strong> - menghitung bobot setiap gejala berdasarkan keterkaitan dan
                                    urutannya</li>
                        ...
                        <div class="mb-4">
                            <h6 class="fw-bold mb-3">
                                1. Proses VCIRS
                                <i class="mdi mdi-help-circle text-muted" data-bs-toggle="tooltip"
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 small text-muted">Jumlah total gejala yang terkait dengan
                                                        gangguan ini</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 small text-muted">Urutan kepentingan gejala (1 = paling
                                                        penting)</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 small text-muted">Total gejala yang valid untuk gangguan
                                                        ini</p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <tr @if ($detail['credit'] > 0) class="table-success" @endif>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div class="text-detail">
                                                        {{ $detail['ns'] }}*{{ number_format($detail['cd'], 4) }}</div>
                                                </td>
                                                <td class="text-center">
                                                    {{ number_format($detail['vur'], 4) }}
                                                    <div class="text-detail">
                                                        {{ $detail['credit'] }}*{{ number_format($detail['weight'], 4) }}
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
                        ...
                        <div class="card shadow-sm mb-4">
                            <div class="card-body">
                                ...
                                <div class="alert alert-light border mb-3">
                                    ...
                                    <p class="mb-0">RUR (Rule Utility Ranking) adalah nilai yang menunjukkan seberapa kuat
                                        keterkaitan antara gejala-gejala yang dipilih dengan suatu penyakit. Nilai ini
                                        dihitung dari hasil VCIRS di atas.</p>
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="alert alert-light border mb-3">
                                ...
                                <p class="mb-0">CF (Certainty Factor) adalah metode untuk menghitung tingkat kepastian
                                    diagnosis dengan menggabungkan:</p>
                                <ul class="mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($row['detail'] as $gejalaId => $detail)
                                            @if ($detail['credit'] > 0)
                                                ...
                                                <tr>
                                                    <td>{{ $gejalas->firstWhere('id', $gejalaId)->nama_gejala }}</td>
                                                    <td class="text-center">{{ number_format($detail['cf_pakar'], 2) }}
                                                    </td>
                                                    <td class="text-center">{{ $detail['credit'] }}</td>
                                                    <td class="text-center">
                                                        {{ number_format($cfHE, 4) }}
                                                        <div class="text-detail">
                                                            {{ number_format($detail['cf_pakar'], 2) }}*{{ $detail['credit'] }}
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        {{ number_format($cfWeighted, 4) }}
                                                        <div class="text-detail">
                                                            {{ number_format($cfHE, 4) }}*{{ number_format($row['rur'], 4) }}
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endif
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                            ...
                                            <td class="small text-muted">
                                                ...
                                                @foreach ($cfCalculations as $index => $calc)
                                                    ...
                                                    @else
                                                        <div class="mt-2">
                                                            CFR{{ $index + 1 }} =
                                                            {{ number_format($calc['running_total'], 4) }}<br>
                                                            <span class="text-muted">&nbsp;&nbsp;= CF{{ $index }} +
                                                                ({{ number_format($calc['cfWeighted'], 4) }} × (1 -
                                                                {{ number_format($cfCalculations[$index - 1]['running_total'], 4) }}))
                                                            </span><br>
                                                            <span class="text-muted">&nbsp;&nbsp;= CF{{ $index }} +
                                                                ({{ number_format($calc['cfWeighted'], 4) }} ×
                                                                {{ number_format(1 - $cfCalculations[$index - 1]['running_total'], 4) }})</span><br>
                                                            <span class="text-muted">&nbsp;&nbsp;=
                                                                {{ number_format($cfCalculations[$index - 1]['running_total'], 4) }}
                                                                +
                                                                {{ number_format($calc['cfWeighted'] * (1 - $cfCalculations[$index - 1]['running_total']), 4) }}</span>
                                                        </div>
                                                    @endif
                                                @endforeach
                                            </td>
                                ...
                                <div class="alert alert-light border mt-3 mb-0">
                                    ...
                                    <ul class="mb-0">
                                        <li>Semakin tinggi persentase, semakin besar kemungkinan diagnosis tersebut tepat
                                        </li>
    ...
    <div class="alert alert-warning">
        ...
        <p class="mb-0">Hasil screening ini hanya berupa gambaran awal kemungkinan gangguan tidur yang anda alami
            berdasarkan gejala yang Anda pilih. Tahap selanjutnya, silakan konsultasikan dengan profesional kesehatan
            seperti psikolog/psikiater.</p>
    </div>
...
@push('styles')
    ...
    <link href="{{ url('dist/assets/libs/datatables.net-bs5/css/dataTables.bootstrap5.min.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ url('dist/assets/libs/datatables.net-responsive-bs5/css/responsive.bootstrap5.min.css') }}"
