    ...
    <div class="col-12">
        <div class="card">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Data Gangguan</h5>
                    <a href="{{ route('gangguan.create') }}" class="btn btn-primary">
                        <i class="mdi mdi-plus"></i> Tambah Gangguan
                    </a>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($items as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('gangguan.edit', $item->id) }}" class="btn btn-info btn-sm">
                                        <span class="mdi mdi-pencil"></span>
                                    </a>
                                    <button type="button" class="btn btn-danger btn-sm"
                                        onclick="handleDelete('{{ $item->id }}', '{{ $item->nama_gangguan }}')">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Apakah Anda yakin ingin menghapus gangguan <span id="gangguanName"></span>?
                            </div>
...
@push('scripts')
    ...
    <script>
        ...
        function handleDelete(id, name) {
            ...
            const gangguanName = document.getElementById('gangguanName');

            deleteForm.action = `{{ url('gangguan') }}/${id}`;
            gangguanName.textContent = name;
