    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Tambah Gangguan</h5>
            </div>
                ...
                <form action="{{ route('gangguan.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('kode_gangguan') is-invalid @enderror"
                            id="kode_gangguan" name="kode_gangguan" value="{{ old('kode_gangguan') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_gangguan') is-invalid @enderror"
                            id="nama_gangguan" name="nama_gangguan" value="{{ old('nama_gangguan') }}"
