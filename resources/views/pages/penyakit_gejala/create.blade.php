            ...
            <div class="card-body">
                <form action="{{ route('penyakit-gejala.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="penyakit_id" class="form-select @error('penyakit_id') is-invalid @enderror" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="position-relative">
                            <select name="gejala_id" class="form-select @error('gejala_id') is-invalid @enderror" required id="gejala_select" disabled>
