...
@section('content')
    <div class="py-3 mt-3 d-flex align-items-sm-center flex-sm-row flex-column">
        <div class="flex-grow-1">
            <h4 class="fs-18 fw-semibold m-0">Tambah Gejala Baru</h4>
            <p class="text-muted mb-0">Tambahkan indikator gejala baru ke sistem pakar</p>
        </div>
        <div class="text-end">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control @error('nama_gejala') is-invalid @enderror"
                                    id="nama_gejala" name="nama_gejala" value="{{ old('nama_gejala') }}"
                                    placeholder="Contoh: Kesulitan tidur di malam hari" required>
                                @error('nama_gejala')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
